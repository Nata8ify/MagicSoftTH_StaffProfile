<div class='row'>
	<div class='col-sm-12'>
	    ...
	    $("#btn-grantadm-grant").click(
		    function() {
			var staffId = $("#input-grantadm-staff-id").val().trim().toUpperCase();
			grantAdminPermission(staffId, true, "Administrator Permission Granted to "+staffId+".");
		    });
	    $("#btn-grantadm-revoke").click(
		    function() {
			var staffId = $("#input-grantadm-staff-id").val().trim().toUpperCase();
			grantAdminPermission(staffId, false, "Administrator Permission Revoked on "+staffId+".");
		    });
/* 	    $("#input-grantadm-staff-id").keyup(function(){
		...
		if (staffId == "") {
			...
			$.ajax({
			    "url" : "grantadm",
			    "data" : {isGrantAdminRole : isAdmGrant, staffId : staffId},
