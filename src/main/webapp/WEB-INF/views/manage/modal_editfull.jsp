			...
			<form name="staff-edit-form" id="staff-edit-form"
				...
				<div class="modal-body">
					<ul class="nav nav-tabs">
						<li class="active"><a data-toggle="tab" href="#tab-profile">Profile
								Editor</a></li>
						<li><a data-toggle="tab" href="#tab-password">Password
								Manager</a></li>
					</ul>
					<br />
					<div class="tab-content">
						<div id="tab-profile" class="tab-pane in active">
							<div class="row control-group">
								<div
									...
									</select> <input type='hidden' id='hide-cur-staffType'
										name='prevEditType' />
								</div>
								<div
							...
							<div class="row control-group">
								<div
									...
									<input type="hidden" name='birthDate' /> <label
										for="birthDate">Birth Date (A.D. : dd-mm-yyyy)</label> <input
										class="form-control" id="birthDate" required=''
										placeholder="A.D. as dd-mm-yyyy"
							...
							<div class="row control-group">
								<div
									...
									<label for="tel">Contact Number</label> <input type="tel"
										class="form-control"
										placeholder="Contact Number (without '-')" id="tel" name='tel'
							...
							<div class="row control-group">
								...
								<div
									...
									<label for="position">Staff's Position</label> <input
										type="text" class="form-control"
										placeholder="Staff's Position" id="position" name='position'
							...
							<div class="row control-group">
								<div class="form-group col-sm-3">
									<input type="button" class='btn btn-info' id='btn-assign-mng'
										value="Assign Manage" />
								</div>
								<div class="form-group col-sm-9">
									<input type="text" class="form-control"
										id="hostManagerName-show" disabled> <input
										type="hidden" id="hostManagerId" name="hostManagerId" />
								</div>
							</div>
							<div class="row control-group">
								<!-- Safe to Remove -->
									...
									<table>
										...
										<tr>
											<td><input type="radio" value="new"
												id='select-portarit-new' name='portraitPathOpt'></td>
											<td></td>
											<td>: Upload New Image</td>
											<td><input style="display: none;" type="file"
												class="form-control" id="protraitPathNew"
												name='protraitPath'></td>
										</tr>
										<tr>
											<td><input type="radio" value="default"
												id='select-portarit-default' name='portraitPathOpt'></td>
											<td></td>
											<td>: Use No Image</td>
										</tr>
									</table>
						...
						<div id="tab-password" class="tab-pane">
							...
							<div class="row control-group">
								<div class="form-group col-xs-12  controls">
									<p><b>Attention</b> : After "Reset a Password" option is checked the system will generate a set of random characters (but you may enter specify a password by your own), after the profile is updated. <u>you have to keep them (password) to the profile owner.</u> </p>
								</div>
							</div>
							<div class="row control-group">
								<div class="form-group col-xs-12  controls">
									<input type="checkbox" class="" id="chkresetpass"
										name='chkresetpass'> <label> : Reset a
										Password </label> <input style="display: none;" class="form-control"
										placeholder="Password" id="password" name='password' required
										data-validation-required-message="Please enter Password."
										disabled>
									<p class="help-block text-danger"></p>
								</div>
								<div class="form-group col-xs-8  controls"></div>
							</div>
						</div>
					</div>
				...
				<div class="modal-footer">
					<div id="div-restore-data-sec" style="float: left;">
						<button type="button" class="btn btn-default"
							id='btn-restore-default'>Restore to Default</button>
						&nbsp;<i id="i-restore-data-mgs" hidden="">Information
							Restored</i>
					</div>
