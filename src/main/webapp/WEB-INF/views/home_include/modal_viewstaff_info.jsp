								...
								<table class='table table-responsive' id='table-staff-mng-info'>
									<tbody>
										<tr>
											<td></td>
											<td>Manager :</td>
											<td><span id='span-info-name-mng-honf'></span><span
												id='span-info-mng'></span><span
												id='span-info-name-mng-locale'></span></td>
										</tr>
										<tr>
											<td></td>
										...
										<tr>
											<td></td>
											<td></td>
											<td><button data-managerId="" id="btn-view-thismng" class="btn btn-default">
													<i class="glyphicon glyphicon-user"></i>View Manager Info
												</button></td>
										</tr>
									</tbody>
								</table>
