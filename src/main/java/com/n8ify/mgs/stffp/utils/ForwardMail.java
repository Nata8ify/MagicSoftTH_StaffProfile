...
public class ForwardMail {
	...
	public void sendIfPasswordSelfEditedMail(Staff staff, String password){
		...
		mailMessage.setText("You have done of editing your information in the Staff Profile System and this is your latest update Information, So, please check"
		+"\nStaff ID : "+staff.getStaffId()
		+"\nName : "+staff.getName()
		+"\nE-mail : "+staff.getEmail()
		+"\nTel. : "+staff.getTel()
		+"\nPassword : "+password
		);
	...
	public void sendEditByAdministratorInfoMail(Staff staff, String password){
		...
		mailMessage.setText("We are completed for editing your information in the Staff Profile System and this is your latest update Information, So, please check"
		+"\nStaff ID : "+staff.getStaffId()
		+"\nName : "+staff.getName()
		+"\nE-mail : "+staff.getEmail()
		+"\nTel. : "+staff.getTel()
